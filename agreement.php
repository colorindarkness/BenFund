...
<form name="form1" method="post" action="https://www.benfund.com/register.php">
  <div align="center">
    <input name="accept" type="hidden" id="accept" value="set">
	<input name="m_type" type="hidden" id="m_type" value="<?php echo $_GET['sid']; ?>">
		<input type="image" src="https://www.benfund.com/images/elements/decline.png"  height="25" width="100" border="0" alt="Decline" name="Submit2" onClick="location='http://www.benfund.com'">&nbsp;&nbsp;
    <input type="image" src="https://www.benfund.com/images/elements/accept.png" height="25" width="100" border="0" alt="Accept" name="Submit" >
