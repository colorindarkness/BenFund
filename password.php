...
<form name="form1" method="post" action="change_pw.php">
        <p>&nbsp;</p>
        ...
        <table width="300" border="0" bgcolor="#CCCCCC">
          ...
          <tr width="300"> 
            ...
            <td><input name="old_pw" type="password" id="old_pw2" size="10" maxlength="10"> 
            </td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td><input name="new_pw" type="password" id="new_pw2" size="10" maxlength="10"> 
            </td>
          </tr>
          <tr> 
            <td><div align="right"><strong>Confirm Password: </strong></div></td>
            <td><input name="confirm_pw" type="password" id="confirm_pw2" size="10" maxlength="10"></td>
          </tr>
          <tr> 
