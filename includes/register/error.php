...
<div class="hr"></div><p>
<span class="medium red bold">Errors were found in your submission. Please correct the errors specified below and submit again.</span>
<div class="error2"><span class="errormsg2"><?php echo $err; ?></span></div><p>
  ...
  <input type="hidden" name="submit" id="submit" value="Next">
  <a href="https://www.benfund.com" ><img src="https://www.benfund.com/images/elements/decline.gif" border="0"></a>
    ...
    <input type="image" src="https://www.benfund.com/images/elements/proceed.gif" border="0" alt="Proceed"  name="proceed" value="Next">
  </p>
        </form>