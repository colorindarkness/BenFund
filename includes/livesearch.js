...
function liveSearchDoSearch() {
	...
	if (liveSearchLast != document.forms.lookup.mid.value) {
	if (liveSearchReq && liveSearchReq.readyState < 4) {
		liveSearchReq.abort();
	}
	if ( document.forms.lookup.mid.value == "") {
		liveSearchHide();
		liveSearchLast = "";
		return false;
	}
	...
	liveSearchReq.open("GET", liveSearchRoot + "includes/accounts.php?mid=" + document.forms.lookup.mid.value + liveSearchParams2);
	liveSearchLast = document.forms.lookup.mid.value;
