...
<span class="medium bold blue">To continue please thoroughly read and agree to the BenFund User Agreement and Privacy Policy.</span>
<div class="agreement">
...
<form name="form1" method="post" action="https://www.benfund.com/register/register.php">
  <div align="center">
    ...
    <input type="image" src="https://www.benfund.com/images/elements/accept.gif" border="0" name="accept" id="accept" alt="Accept" value="set">
