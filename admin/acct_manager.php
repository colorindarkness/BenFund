...
benfund_connect();
$sql1 = "DELETE FROM mpages WHERE mid = $mid";
$result1 = mysql_query($sql1);
benfund_connect();
$sql2 = "DELETE FROM mtemplates WHERE mid = $mid";
...
<tr>
<th valign="top" width="5" class="tablehead"><input name="toggle" value="" onclick="checkAll(50);" type="checkbox"></th><th valign="top" width="20" class="tablehead"><b>ID</b></th><th valign="top" class="tablehead"><b>Name</b></th><th valign="top" class="tablehead"><b>Type</b></th><th valign="top" class="tablehead"><b>Goal</b></th><th valign="top" class="tablehead"><b>Status</b></th><th valign="top" class="tablehead">&nbsp;</th>
</tr>
<?php

benfund_connect();
$query = "SELECT id, m_type, name, goal, activated FROM merchant WHERE id like '%' ";
...
?>
<tr class="<?php echo $row_color; ?>"><td valign="top" width="20"><input id="cb0" name="cid[]" value="<?php echo $mid; ?>" onclick="isChecked(this.checked);" type="checkbox"></td><td valign="top" width="20"><?php echo $mid; ?></td><td valign="top" width="250"><a href="edit_acct.php?mid=<?php echo $mid; ?>"><?php echo $name; ?></a></td><td valign="top"><?php echo $m_type; ?></td><td valign="top"><?php echo $goal; ?></td><td valign="top"><?php echo $status; ?></td><td valign="top"><a onclick="return confirmDelete()" href="acct_manager.php?cmd=del&mid=<?php echo $mid; ?>"><img src="https://www.benfund.com/images/elements/icons/sm/delete.gif" border="0" /></a></td></tr>
<?php
$row_count++;
 } ?>
</table>
