<?php
$page_title = "BenFund Client Registration";
...
<center><img src="https://www.benfund.com/images/elements/progress-1.gif"></center><p>
	<span class="pagetitle">BenFund Client Registration</span>
	<div class="hr"></div><p>
...
<form name="form1" method="post" action="https://www.benfund.com/register/register.php">
  <div align="center">
    ...
    <a href="https://www.benfund.com/register_client/agreement.php?sid=<?php echo $aid; ?>"><img src="https://www.benfund.com/images/elements/proceed.gif" border="0" alt="Accept"></a>
