...
<form name="contactUs" action="https://www.bordersstores.com/servlet/FMP" method="get">
	...
	<input size="25" name="first_name" value="" type="text" class="big">
	<br>
	<br>
	
	<span class="emphasis">* Last Name:</span><br>

	
	<input size="25" name="last_name" value="" type="text" class="big">
	<br>
	<br>
	
	<span class="emphasis">Email Address:</span><br>
	<input size="25" name="email" value="" type="text" class="big">
	<br>
	<br>
	
	<span class="emphasis">* Topic</span><br>
	
	<select name="email_subject" class="big">
	...
	<span class="emphasis">* Your Message (Please limit to 1000 characters)</span><br>
	
	<textarea name="comments" cols="30" rows="5" wrap="virtual" class="big"></textarea>
	<br>
	<br>
