	...
	<tr>
		<td>
			<table class="toolbar" align="right">
				<tr>
					<td align="center"><a class="toolbar" href="https://www.benfund.com/client/payment_manager/view_invoice.php?iid=<?php echo $iid ?>"><img src="https://www.benfund.com/images/elements/icons/invoice.png" border="0"><br>View Invoice</a></td>
		...
		<table>
			<tr>
				...
				<td valign="top">
					...
					<span class="emphasis2"><?php echo $inv ?></span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://www.benfund.com/client/payment_manager/view_invoice.php?iid=<?php echo $iid; ?>">View Invoice&nbsp;<img src="https://www.benfund.com/images/elements/icons/sm/view.png" border="0" /></a><br>
