...
/**/
benfund_connect();
$iq = "SELECT * FROM invoice WHERE from_id='$mid' AND id ='$inv_num'";
...
benfund_connect();
$cq = "SELECT * FROM client WHERE cid='$to'";
$c_result = mysql_query($cq);
...
benfund_connect();
$mq = "SELECT * FROM merchant WHERE id='$mid'";
$m_result = mysql_query($mq);
...
<table width="587" height="759" border="0" cellspacing="0" cellpadding="4" style="border: 1px solid #000000; width: 587px; height: 759px;" valign="top">
  <tr>
...
<img src="https://www.benfund.com/images/acct/logo/<?php echo $mid;?>.jpg" height="75" width="75">
    ...
    <td align="right" valign="top"><b><font size="6" face="Arial, Helvetica, sans-serif">Payment Receipt</font></b><br />
      <table border="0" cellspacing="0" cellpadding="0" class="inv" >
        <tr>
          <th width="140" bgcolor="#E6E6E6"><b><font size="4" face="Arial, Helvetica, sans-serif">Payment Date</font></b></th>
          <th width="140" bgcolor="#E6E6E6"><b><font size="4" face="Arial, Helvetica, sans-serif">Invoice Ref#</font></b></th>
        </tr>
        <tr>
  ...
  <tr>
    <td valign="top">
      <table width="100%" border="0" cellspacing="0" cellpadding="4" class="inv" valign="top">
        <tr>
          <th bgcolor="#E6E6E6"><b><font size="4" face="Arial, Helvetica, sans-serif">Payed By</font></b></th>
        </tr>
        <tr>
    ...
    <?php if(isset($shipping)){ ?>
      <table width="100%" border="0" cellspacing="0" cellpadding="4" class="inv" valign="top">
        <tr>
          <th bgcolor="#E6E6E6"><b><font size="4" face="Arial, Helvetica, sans-serif" valign="top">Payment Information</font></b></th>
        </tr>
        <tr>
          <td align="left" valign="top">
          Amount Paid: $<?php echo $reciept[9]." (USD)"; ?><br>
          Payment Method: <?php echo $paymethod; ?><br>
          Card Number: <?php echo $hideccnum; ?><br>
          Payment Status: Cleared<br>
          </td>
        </tr>
      </table>
    <?php } ?>
...
?>
       ...
       <?php } ?>
        ...
        <tr>
          <th bgcolor="#E6E6E6" valign="top"><font size="4" face="Arial, Helvetica, sans-serif"><b>Total Payed</b></font></th>
