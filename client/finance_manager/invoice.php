...
benfund_connect();
$sumquery = "SELECT SUM(amount) AS paytotal FROM payments WHERE cid='$cid'";    
...
<img src="https://www.benfund.com/images/merchant/logo/<?php echo $mid;?>.jpg" height="75" width="75">
          </td>
