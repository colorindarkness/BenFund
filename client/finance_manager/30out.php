...
<?php
benfund_connect();
$result = mysql_query("SELECT * FROM invoice WHERE date BETWEEN DATE_SUB(CURDATE(),INTERVAL 30 DAY) AND DATE_SUB(CURDATE(),INTERVAL 1 DAY) AND from_id='$mid' ORDER BY id DESC");
$color1 = "row0";
$color2 = "row1";
$row_count = 0;
