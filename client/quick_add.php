...
<form method="post" action="client_manager.php?cmd=quickadd" name="quickadd">
...
<input type="text" size="20" id="email" name="email" value="" class="big"/><p>
