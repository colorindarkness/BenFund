...
if(isset($updated)){
	...
	benfund_connect();
	$update_settings_query = "UPDATE merchant SET settings='$new_settings' WHERE id = '$mid' ";
	...
	benfund_connect();
	$update_pw_query = "UPDATE merchant SET password='$new_pw' WHERE id = '$mid' ";
...
benfund_connect();
$settings_query = "SELECT email, settings FROM merchant WHERE id = '$mid' ";
