...
<tr><td align="center"><a class="toolbar" href="https://www.benfund.com/acct/message_center.php"><img src="https://www.benfund.com/images/elements/icons/med/msg-cntr.png" border="0"height="32" width="32" /></td>
...
<tr><td align="center"><a class="toolbar" href="https://www.benfund.com/acct/message_center.php">Message Center</a></td>
...
<tr><td align="center">
<form name="reply" id="reply" action="https://www.benfund.com/acct/message.php?cmd=reply" method="post">
...
<td align="center">
<form name="forward" id="forward" action="https://www.benfund.com/acct/message.php?cmd=forward" method="post">
<input type="hidden" id="msg_id" name="msg_id" value="<?php echo $msg_id; ?>">
...
<td align="center"><form name="delete_msg" id="delete_msg" action="https://www.benfund.com/acct/message_center.php?cmd=delete" method="post">
<input type="hidden" id="msg_id" name="msg_id" value="<?php echo $msg_id; ?>">
...
<td align="center"><a class="toolbar" href="https://www.benfund.com/acct/message_center.php"><img src="https://www.benfund.com/images/elements/icons/delete_page.gif" border="0"/></a></td>
</tr>
<tr><td align="center"><a class="toolbar" href="javascript:document.compose_new.submit();">Send</a></form></td>
<td align="center"><a class="toolbar" href="https://www.benfund.com/acct/message_center.php">Cancel</a></td>
</tr>
</table>
</td></tr></table>
</td></tr>
...
<?php } if ($cmd == 'reply'){ ?>
	...
	<div class="content_outer">
	<div class="content_inner">
<form name="reply_send" id="reply_send" action="https://www.benfund.com/acct/message_center.php?cmd=reply" method="post">
	<table class="toolbar" align="right">
<tr><td align="center"><a class="toolbar" href="https://www.benfund.com/acct/message_center.php"><img src="https://www.benfund.com/images/elements/icons/med/msg-cntr.png" border="0"height="32" width="32" /></td>
<td align="center"><a class="toolbar" href="https://www.benfund.com/acct/message.php?cmd=compose"><img src="https://www.benfund.com/images/elements/icons/med/mail-compose.png" border="0"height="32" width="32" /></td>
</tr>
<tr><td align="center"><a class="toolbar" href="https://www.benfund.com/acct/message_center.php">Message Center</a></td>
<td align="center"><a class="toolbar" href="https://www.benfund.com/acct/message.php?cmd=compose">Compose Message</a></td>
</tr>
</table>
...
<?php } if ($cmd == 'forward'){ ?>
	...
	<div class="content_outer">
	<div class="content_inner">
<form name="forward_send" id="forward_send" action="https://www.benfund.com/acct/message_center.php?cmd=forward" method="post">
	<table class="toolbar" align="right">
<tr><td align="center"><a class="toolbar" href="https://www.benfund.com/acct/message_center.php"><img src="https://www.benfund.com/images/elements/icons/med/msg-cntr.png" border="0"height="32" width="32" /></td>
<td align="center"><a class="toolbar" href="https://www.benfund.com/acct/message.php?cmd=compose"><img src="https://www.benfund.com/images/elements/icons/med/mail-compose.png" border="0"height="32" width="32" /></td>
</tr>
