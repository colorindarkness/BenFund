...
<table width="95%" border="0" onload="Repaginate()">
	<tr>
		<td valign="top">
			The following are invoices from 60 to 89 days ago.
		</td>
		<td valign="top">
			<div style="text-align: right; display: block;">
			Records per Page:<br />
			<select class="nice" onchange="rowsDisplayed(document.getElementById('mdfmk'), document.getElementById('mdfmk').className, this.value); Repaginate()">
...
<div id="datatable">
<table class="sortable-onload-1-reverse no-arrow paginate-5" id="mdfmk" align="center" border="0" cellpadding="4" cellspacing="0" width="95%">
<tr>
