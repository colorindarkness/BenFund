...
<?php
benfund_connect();
$comment_result = mysql_query("SELECT id, comment_name, comment_title, comment_text, comment_time FROM comments WHERE mid='$mid' AND approved ='1' AND comment_private='1'");
$color1 = "row0";
$color2 = "row1";
$row_count = 0;
