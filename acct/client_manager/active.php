...
<table class="tablesorter" id="climanact" align="center" border="0" cellpadding="4" cellspacing="0" width="95%">
<thead>
<tr>
...
<?php
benfund_connect();
$result = mysql_query("SELECT cid, first_name, m_i, last_name, balance, activated FROM client WHERE mid = '$mid' AND deleted = '0' AND activated = '1' ORDER BY last_name");
$color1 = "row0";
$color2 = "row1";
$row_count = 0;
...
<td valign="top" width="250"><a href="https://www.benfund.com/acct/client.php?cid=<?php echo $cid; ?>"><?php echo $balance; ?></a></td><td valign="top"><?php echo $status; ?></td>
</tr>
<?php
}else{
	?>
