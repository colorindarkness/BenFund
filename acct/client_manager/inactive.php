...
<table class="tablesorter" id="climaninact" align="center" border="0" cellpadding="4" cellspacing="0" width="95%">
<thead>
<tr>
...
<?php
benfund_connect();
$result = mysql_query("SELECT cid, first_name, m_i, last_name, balance, activated FROM client WHERE mid = '$mid' AND deleted = '0' AND activated = '0' ORDER BY last_name");
$color1 = "row0";
$color2 = "row1";
$row_count = 0;
